...
class app():
    ...
    def crear_widgets(self):
        ...
        self.frame = ttk.Frame(self.root, padding = 12, relief= "flat", style = "secondary")
    ...
    def realizar_calculo(self):
        ...
        res_text = str(resultado.rhs).replace("**", "^")
        
        re_label = ttk.Label(self.frame, text=f"Solución: y = {res_text}")
        re_label.pack(pady=10)
        re_label.config(foreground= "#0f4bd6", font = ("bold"))
